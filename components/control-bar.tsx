...
type ControlsBarProps = {
  ...
  agentTrigger?: React.ReactNode; // ✅ new preferred slot
  voiceTrigger?: React.ReactNode; // ✅ deprecated (kept for compatibility)
    ...
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-1.5">
          {(agentTrigger ?? voiceTrigger) /* ✅ prefer new prop */}
          {logsTrigger}
          {transcriptTrigger}
          {usageTrigger}
          {selfTest}
